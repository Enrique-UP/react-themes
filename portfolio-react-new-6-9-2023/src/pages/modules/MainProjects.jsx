...
import img3 from "../../images/portfolio/travomint_com.jpg";
import img4 from "../../images/portfolio/thelabelbar_com.jpg";
import img5 from "../../images/portfolio/careerera_com.jpg";
...
const MainProjects = () => {
    useEffect(() => {
        ...
        //     });
        // });
        // document.querySelector(".mainProjects").addEventListener("click", function(e){
        //     e.stopPropagation();
        // });
    }, []);
    const MainProjectsData = [
        ...
        {            
            template : img3,
            duration : "2017-2021",
            link : () => window.open('https://travomint.com/'),
            title : "travomint_com_title",
            text : "travomint_com_text",
            category : "Travel",
            name : "travomint_com"
        },
        {            
        ...
        {            
            ...
            duration : "2020-2022",
            link : () => window.open('#'),
            title : "careerera_com_title",
            text : "careerera_com_text",
            category : "Travel",
            name : "careerera_com"
        },
        {            
